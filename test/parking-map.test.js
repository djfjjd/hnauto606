...
test('기본 층 도면은 9×20 주차 Cell을 자동 생성한다',()=>{
  const html=renderParkingMap(parkingLayouts.pillar11,[]);
...
test('차량 Cell에는 차량번호 뒤 4자리만 크게 표시한다',()=>{
  const html=renderParkingMap(parkingLayouts.pillar11,[{id:'spot-1',label:'A1',plate:'186저9439',model:'쏘나타',alerts:[]}]);
